...
public class MilkTea_Ordering_System extends javax.swing.JDialog {
    ...
    private void rb_exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rb_exitActionPerformed
        ...
        System.exit(0);
         ...
         return flavors.get(1);
         } else if (rb_matcha.isSelected()) {
         return flavors.get(2);
         } else if (rb_honeydew.isSelected()) {
         return flavors.get(3);
         } else {
         return ""; 
         }
     }
         ...
         return cupsize.get(0);
         } else if (rbmeduim.isSelected()) {
         return cupsize.get(1);
         } else if (rblarge.isSelected()) {
         return cupsize.get(2);
         } else {
         return ""; 
         }
     }
         ...
         private void addToCart() {
             String selectedFlavor = getSelectedFlavor();
    ...
    // Add additional charges for boba and jelly
    if (addBoba) {
    ...
    ((DefaultTableModel) cartTableModel.getModel()).addRow(new Object[]{cartItem, "₱" + formattedPrice});
        ...
        // Remove the selected row
          double removedPrice = extractPriceFromCartItem((String) defaultCartTableModel.getValueAt(selectedRow, 1));
           defaultCartTableModel.removeRow(selectedRow);
    ...
    return Double.parseDouble(priceString.substring(1)); // Skip the '$' character
}
    ...
    // Clear the table model data after placing the order
